const CONFIG = {
  ...
  keywords: {
    ...
    source: 'official_google_trends_api_same_request_plus_browser_chart',
    anchor: 'mirofish',
    relativeHeatUnit: 'termAvg / mirofishAvg',
    timeframe: 'today 12-m',
    geo: 'Worldwide',
    collectedAt: '2026-06-27T05:21:10Z',
    confirmedTrafficKeywords: 14,
    confirmedPrimaryKeywords: 6,
    confirmedLongTailKeywords: 8,
    minRelativeHeatVsMirofish: 0.0046,
    maxRelativeHeatVsMirofish: 54.4675,
  },
}
...
async function handleFacts(request, env) {
  return jsonResponse({
    ...
    keywordEvidence: {
      ...
      source: CONFIG.keywords.source,
      anchor: CONFIG.keywords.anchor,
      relativeHeatUnit: CONFIG.keywords.relativeHeatUnit,
      relativeHeatVsMirofish: `${CONFIG.keywords.minRelativeHeatVsMirofish}-${CONFIG.keywords.maxRelativeHeatVsMirofish}`,
      confirmedTrafficKeywords: CONFIG.keywords.confirmedTrafficKeywords,
      confirmedPrimaryKeywords: CONFIG.keywords.confirmedPrimaryKeywords,
      confirmedLongTailKeywords: CONFIG.keywords.confirmedLongTailKeywords,
      collectedAt: CONFIG.keywords.collectedAt,
    },
    paidAccess: {
      provider: 'polar',
